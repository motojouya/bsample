...
export type SendEmailRegisterSessionMutation = { sendEmail: { register_session_id: number | null, email: string } | { message: string } | {} | null };
...
export type SendEmailLoginedMutation = { sendEmail: { email: string } | { message: string } | {} | null };
