...
export class EngageService {
  ...
  async verifyEmail(loginUser: User, register_session_id: string, email: string, email_pin: string): Promis<null | RecordNotFoundError> {
  ...
  async changePassword(loginUser: User, password: string): Promise<User> {
